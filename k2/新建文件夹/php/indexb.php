...
<div class="box1">
  ...
  <tr>
    <td width="91" height="40">用户名：</td>
    <td width="193" height="40"><label for="mm"></label>
      <input type="text" name="username" id="textfield2">
      *</td>
  </tr>
  <tr>
    <td height="40">密码：</td>
    <td height="40"><label for="mm2"></label>
      <input type="password" name="mm" id="textfield3">
      *</td>
  </tr>
  <tr>
    <td height="40">确认密码：</td>
    <td height="40"><label for="name"></label>
      <input type="password" name="mm2" id="textfield4">
      *</td>
  </tr>
  <tr>
    <td height="40">昵称：</td>
    <td height="40"><label for="diz"></label>
      <input type="text" name="name" id="textfield5">
      *</td>
  </tr>
  <tr>
    <td height="40">性别：</td>
    <td height="40"><input name="sex" type="radio" id="radio" value="男" checked="CHECKED">
      <label for="sex">男
  ...
  <tr>
    ...
    <td height="40"><input type="text" name="diz" id="textfield"></td>
  </tr>
  <tr>
    <td height="40">联系邮箱：</td>
    <td height="40"><input type="text" name="youx" id="youx">
      *</td>
  </tr>
  <tr>
    <td height="40">&nbsp;</td>
    <td height="40"><input type="submit" name="button" id="button" value=""></td>
  </tr>
</table>
